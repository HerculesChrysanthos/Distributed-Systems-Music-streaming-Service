...
public class Broker{
	...
	public void  pull(int PublisherIndex,ArtistName art,String songTtile,ObjectOutputStream serverOut,ObjectInputStream serverIn){
		...
		try {
			...
			try {
				...
				out.writeObject(songTtile);
				songFound = (boolean)input.readObject();
				serverOut.writeObject(songFound);
				while(!songFound){
					sendMessage = "The name of song that you entered doesn't exist, please give the correct title: ";
					serverOut.writeObject(sendMessage);
